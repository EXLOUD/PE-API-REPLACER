# -*- coding: utf-8 -*-
"""
DLL replacement configuration for PE Patcher.

IMPORTANT: For binary (hex) patching the replacement string length
MUST match the original string length exactly.
Use null bytes \\x00 to pad if needed.
"""
