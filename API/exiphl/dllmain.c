...
void InitializeHardcodedConfig() {
    LogInfo("Initializing hardcoded network configuration...");
    ...
    LogInfo("Hardcoded config initialized. Adapters: %d, ARP entries: %d", g_NetworkState.adapterCount, g_NetworkState.arpCacheCount);
}
