#!/usr/bin/env pwsh
# ============================================================================
# EXTRUST.dll - Build Script (CMake + Ninja + LLVM)
# ============================================================================
$ErrorActionPreference = "Stop"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host " EXTRUST.dll Build Configuration" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# ============================================================================
# Конфігурації збірки (тільки UCRT)
# ============================================================================
$configurations = @(
    @{
        Runtime = "ucrt"
...
function Build-Configuration {
    ...
    $dllPath = "$outputDir/EXTRUST.dll"
    $libPath = "$outputDir/EXTRUST.lib"
...
Write-Host "  ucrt/x64/EXTRUST.dll + EXTRUST.lib" -ForegroundColor Gray
Write-Host "  ucrt/arm64/EXTRUST.dll + EXTRUST.lib" -ForegroundColor Gray
Write-Host "  ucrt/x32/EXTRUST.dll + EXTRUST.lib" -ForegroundColor Gray
Write-Host ""