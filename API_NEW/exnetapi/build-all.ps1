#!/usr/bin/env pwsh
# ============================================================================
# EXNETAPI.dll - Build Script (CMake + Ninja + LLVM)
# ============================================================================
...
# Налаштування
# ============================================================================
$NETWORK_MODE = "WORKGROUP"  # WORKGROUP, DOMAIN, STANDALONE

Write-Host "========================================" -ForegroundColor Cyan
Write-Host " EXNETAPI.dll Build Configuration" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "NETWORK_MODE: $NETWORK_MODE" -ForegroundColor White
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
function Build-Configuration {
    ...
    $dllPath = "$outputDir/EXNETAPI.dll"
    $libPath = "$outputDir/EXNETAPI.lib"
...
Write-Host "  ucrt/x64/EXNETAPI.dll + EXNETAPI.lib" -ForegroundColor Gray
Write-Host "  ucrt/arm64/EXNETAPI.dll + EXNETAPI.lib" -ForegroundColor Gray
Write-Host "  ucrt/x32/EXNETAPI.dll + EXNETAPI.lib" -ForegroundColor Gray
Write-Host ""
Write-Host "Network Mode: $NETWORK_MODE" -ForegroundColor White
Write-Host ""